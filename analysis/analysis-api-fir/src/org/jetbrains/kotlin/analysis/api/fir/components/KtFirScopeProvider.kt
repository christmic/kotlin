...
internal class KtFirScopeProvider(
    ...
    override fun getDeclaredMemberScope(classSymbol: KtSymbolWithMembers): KtScope {
        ...
        // TODO: better to create the scope via [FirSession#declaredMemberScope]? (e.g., scope cache?)
        // TODO: better to handle this case via [withFirForScope] below?
        //  Those will require FirScript <: FirClass hierarchy change, though.
