...
sealed class KtFirDiagnostic<PSI : PsiElement> : KtDiagnosticWithPsi<PSI> {
    ...
    abstract class MultiFieldValueClassWithInlineModifier : KtFirDiagnostic<PsiElement>() {
        override val diagnosticClass get() = MultiFieldValueClassWithInlineModifier::class
    }
