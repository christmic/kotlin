...
class UndiscoveredExpectVisitor(
    ...
    override fun visitClass(klass: KtClass) {
        ...
        symbolTable.referenceClass(klass.findExpectForActual(BindingContext.CLASS) ?: return)
    }
    ...
    private inline fun <K : PsiElement, reified D : MemberDescriptor> K.findExpectForActual(bindingContextKey: WritableSlice<K, D>): D? {
        val descriptor = bindingContext[bindingContextKey, this]?.takeIf { it.isActual } ?: return null
