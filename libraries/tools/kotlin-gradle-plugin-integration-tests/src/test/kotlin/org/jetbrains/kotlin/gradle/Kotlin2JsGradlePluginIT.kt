...
class Kotlin2JsIrGradlePluginIT : AbstractKotlin2JsGradlePluginIT(true) {
    ...
    fun testKotlinJsPackageModuleName(gradleVersion: GradleVersion) {
        project("kotlin-js-package-module-name", gradleVersion) {
            build("assemble") {
                assertFileInProjectExists("build/${Distribution.DIST}/productionExecutable/kotlin-js-package-module-name.js")
    ...
    fun testBrowserDistribution(gradleVersion: GradleVersion) {
        project("kotlin-js-browser-project", gradleVersion) {
            ...
            build("assemble") {
                ...
                if (irBackend) {
                    assertFileInProjectExists("app/build/${Distribution.DIST}/productionExecutable/app.js")
                } else {
            ...
            build("clean", "browserDistribution") {
                ...
                if (irBackend) {
                    assertFileInProjectExists("app/build/${Distribution.DIST}/productionExecutable/index.html")
                } else {
